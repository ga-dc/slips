var slips = {
  ...
  "Week 04": [
    ...
    "'I'm the world's #0 programmer!' Explain the joke.",
    "Explain the difference between referencing and invoking a function.",
    "Write a JavaScript Object literal with at least one property and one method (e.g. a dog).",
  ...
  "Week 08": [
    ...
    "Write the url to request all Artists from a Rails Tunr API, formatted as JSON.",
